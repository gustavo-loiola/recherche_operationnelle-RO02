...
def solve_mst(nodes, edges, computeMin=True):
    ...
    tree = kruskal(g, computeMin=computeMin)

    if tree:
        print("Arbre couvrant de poids minimal trouvé :" if computeMin else "Arbre couvrant de poids maximal trouvé :")
        print(tree)
    else:
...
print("\nRésolution du graphe 1 max:" )
solve_mst(nodes1, edges1, computeMin=False)
...
solve_mst(nodes2, edges2)

print("\nRésolution du graphe 2 max:")
solve_mst(nodes2, edges2, computeMin=False)